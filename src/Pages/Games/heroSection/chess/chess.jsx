...
//                                 className={`box ${rowIndex % 2 === colIndex % 2 ? 'light' : 'dark'}`}
//                                 id={`b${rowIndex * 100 + colIndex + 1}`}
//                                 onClick={() => this.handleBoxClick(`b${rowIndex * 100 + colIndex + 1}`)}
//                             >
//                                 {this.renderPiece(rowIndex * 100 + colIndex + 1)}
//                             </li>
//                         ))}
//                     </div>
//                 ))}
...
// renderPiece(squareId) {
//     const pieceType = this.state[squareId];
//     switch (pieceType) {
//         case 'Wpawn':
//             return <img src={whitePawn} alt="White Pawn" />;
//         case 'Bpawn':
//             return <img src={blackPawn} alt="Black Pawn" />;
//         default:
//             return null; 
//     }
// }
